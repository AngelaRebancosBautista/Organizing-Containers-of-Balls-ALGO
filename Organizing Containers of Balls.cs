...
class Result
{
    ...
    public static string organizingContainers(List<List<int>> container)
    {
        ...
        List<long> containerCapacities = new List<long>();
        // Total number of balls of each type
        List<long> typeCounts = new List<long>(new long[n]);
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            containerCapacities.Add(rowSum);
        }
